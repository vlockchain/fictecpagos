...
var overviewPage = {
    init: function() {
        ...
        // Announcement feed
        $.ajax({
            url:"https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&q=http://updates.fictecpagos.co/rss",
            dataType: 'jsonp'
        ...
        menu = [{
                 ...
                 {
                     name: ' About&nbsp;FICTECpagos...',
                     img: 'qrc:///icons/fictecpagos',
                     fun: function () {
    ...
    $("#recipients").append((
        ...
        +  '<div id="recipient[count]" class="recipient"> \
            <div class="flex-right"> \
                ...
                <input id="pay_to[count]" class="pay_to input_box" title="The address to send the payment to  (e.g. PzjjetSdTwrppUwwNUo1GFHYTibzJi77jM)" placeholder="Enter an FICTECpagos address (e.g. PzjjetSdTwrppUwwNUo1GFHYTibzJi77jM)" maxlength="128" oninput="base58.check(this);" onchange="$(\'#label[count]\').val(bridge.getAddressLabel(this.value));"/> \
            ...
            <div class="flex-left"> \
                ...
                <select id="unit[count]" class="unit button is-inverse has-fixed-icon"  style="margin-left:10px; height:43px; width:100px;" onchange="unit.format(\'#amount[count]\', $(this).val());"> \
                    <option value="0" title="FICTECpagos"                    ' + (unit.type == 0 ? "selected" : "") + '>OK</option> \
                    <option value="1" title="Milli-FICTECpagos (1 / 1000)"   ' + (unit.type == 1 ? "selected" : "") + '>mOK</option> \
                    <option value="2" title="Micro-FICTECpagos (1 / 1000000)"' + (unit.type == 2 ? "selected" : "") + '>&micro;OK</option> \
